    ...
    <AnimatePresence>
      ...
      >
        <button
          ...
          className="w-full max-w-md mx-auto bg-primary text-white p-4 rounded-[2rem] shadow-[0_20px_50px_rgba(255,107,0,0.3)] flex items-center justify-between px-8 pointer-events-auto active:scale-95 transition-all group"
        >
